...
| hud-network | Systems | Health capsule, shared leaderboard, exploration fog, local minimap, full-screen universe map, HUD values, settings, Haptics, Advanced Debug player/session IDs, reconnect, brief-disconnect return |
