...
The minimap shows nearby space; M or Map opens the full shared chart. Both follow your travel direction, matching the viewport and furnace destination map. The N marker keeps pointing north. Discovered furnaces appear as flames and dark lots stay marked; their names appear on the chart only after you zoom in close, and only lit furnaces show fire trails. Explored ground has a pale blue tint; dark fog hides uncharted rocks and loot.
