...
and does not stop environmental collisions. Exploding loot bypasses the
shield and can hurt allies and the shooter. Spawn protection blocks that
blast too.
...
kit's health, resets mass growth, clears shield and upgrade state, and grants temporary spawn protection. Human respawns are placed within
