...
thrust. On slopes, holding the nose parallel to a contour adds extra speed,
shown by wind streaks sliding aft over the wings. A small turn removes the
speed and the streaks. Other headings keep nearly full cruise with a light
downhill tug. Steep climbs are only a bit slower; descents more than double
ordinary cruise. Boost stacks with the parallel lane and with downhill speed.
