...
export const DESKTOP_CONTROLS_HINT =
  'Always thrust · Mouse, A/D or left/right arrows to steer · Space fires · Shift or right-click boost · E ability · V schematic · B store · M map';
export const TOUCH_CONTROLS_HINT =
  'Always thrust · Drag to steer · Tap to fire · Boost · Ability · Hold ship to equip · E enters store at Town Square · Map button';
